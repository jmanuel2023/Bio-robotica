        ...
        <div id="Solicitudes">
            <?php
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<thead>
                            <tr>
                            <td colspan='6'><center>Integrantes del Club de Bio-Robotica</center></td>
                            </tr>
                            <tr>
                                <th>Nombre</th>
                                <th>Apellidos</th>
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<tr>";
                        echo "<td colspan='6'>
                            <form action='../database/Integrantes/dar_de_baja.php' method='post'>
                    ...
                    echo "<h2>No existen usuarios para visualizar</h2>";
                }
                $conn->close();
            ?>
        </div>
