...
<body>
  <header id="cabecera">
    <div id="d1">
      ...
      <a href="./Club.php"><img src="../img/icons/home.png" alt="home" class="logoprincipalsecundario"></a>
  ...
  <main id="principal">
    <section id="izquierda">
      ...
      <nav class="nav-bar" id="nav-bar">
        ...
        <?php
          $nivel = 3; //Este nivel nos servirá para que funcione el js que nos dio la profa, y se puedan desplegar los div
